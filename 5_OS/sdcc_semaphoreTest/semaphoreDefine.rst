      ...
      000000                        222 	.ds 8
                                    ...
                                    225 ;--------------------------------------------------------
                                    226 	.area DSEG    (DATA)
                           000036   227 _empty	=	0x0036
                           000037   228 _full	=	0x0037
                           000038   229 _mutex	=	0x0038
                           000039   230 _n	=	0x0039
                                    231 ;--------------------------------------------------------
      ...
      000000 02 00 33         [24]  285 	ljmp	__sdcc_gsinit_startup
                                    286 ;--------------------------------------------------------
      ...
      000006 02 00 03         [24]  300 	ljmp	__sdcc_program_startup
                                    301 ;--------------------------------------------------------
                                    302 ; Home
                                    303 ;--------------------------------------------------------
                                    304 	.area HOME    (CODE)
      ...
      000003 02 00 09         [24]  307 	ljmp	_main
                                    ...
                                    315 ;------------------------------------------------------------
                                    316 ;	semaphoreDefine.c:44: void main(){
                                    317 ;	-----------------------------------------
                                    318 ;	 function main
                                    319 ;	-----------------------------------------
      000009                        320 _main:
                           ...
                           000001   327 	ar1 = 0x01
                           000000   328 	ar0 = 0x00
                                    329 ;	semaphoreDefine.c:45: n = 1;
      000009 75 39 01         [24]  330 	mov	_n,#0x01
                                    331 ;	semaphoreDefine.c:46: SemaphoreCreate(mutex, n);
      00000C C2 AF            [12]  332 	CLR 0xAF 
      00000E 85 39 38         [24]  333 	MOV _mutex, _n 
      000011 D2 AF            [12]  334 	SETB 0xAF 
                                    335 ;	semaphoreDefine.c:48: n = 3;
      000013 75 39 03         [24]  336 	mov	_n,#0x03
                                    337 ;	semaphoreDefine.c:49: SemaphoreCreate(empty, n); 
      000016 C2 AF            [12]  338 	CLR 0xAF 
      000018 85 39 36         [24]  339 	MOV _empty, _n 
      00001B D2 AF            [12]  340 	SETB 0xAF 
                                    341 ;	semaphoreDefine.c:51: n = 0;
      00001D 75 39 00         [24]  342 	mov	_n,#0x00
                                    343 ;	semaphoreDefine.c:52: SemaphoreCreate(full,n);
      000020 C2 AF            [12]  344 	CLR 0xAF 
      000022 85 39 37         [24]  345 	MOV _full, _n 
      000025 D2 AF            [12]  346 	SETB 0xAF 
                                    347 ;	semaphoreDefine.c:54: while(1){
      000027                        348 00102$:
                                    349 ;	semaphoreDefine.c:55: SemaphoreWait(empty);
      000027                        350 		0$:
      000027 85 36 E0         [24]  351 	MOV ACC, _empty 
      00002A 60 FB            [24]  352 	JZ 0$ 
      00002C 20 E7 F8         [24]  353 	JB 0xE7, 0$ 
      00002F 15 36            [12]  354 	DEC _empty 
                                    355 ;	semaphoreDefine.c:57: }
      000031 80 F4            [24]  356 	sjmp	00102$
                                    357 ;------------------------------------------------------------
                                    358 ;Allocation info for local variables in function '_sdcc_gsinit_startup'
                                    359 ;------------------------------------------------------------
                                    360 ;	semaphoreDefine.c:59: void _sdcc_gsinit_startup(void) {
                                    361 ;	-----------------------------------------
                                    362 ;	 function _sdcc_gsinit_startup
                                    363 ;	-----------------------------------------
      000033                        364 __sdcc_gsinit_startup:
                                    365 ;	semaphoreDefine.c:60: main();
                                    366 ;	semaphoreDefine.c:61: }
      000033 02 00 09         [24]  367 	ljmp	_main
                                    368 ;------------------------------------------------------------
                                    369 ;Allocation info for local variables in function '_mcs51_genRAMCLEAR'
                                    370 ;------------------------------------------------------------
                                    371 ;	semaphoreDefine.c:62: void _mcs51_genRAMCLEAR(void) { }
                                    372 ;	-----------------------------------------
                                    373 ;	 function _mcs51_genRAMCLEAR
                                    374 ;	-----------------------------------------
      000036                        375 __mcs51_genRAMCLEAR:
      000036 22               [24]  376 	ret
                                    377 ;------------------------------------------------------------
                                    378 ;Allocation info for local variables in function '_mcs51_genXINIT'
                                    379 ;------------------------------------------------------------
                                    380 ;	semaphoreDefine.c:63: void _mcs51_genXINIT(void) { }
                                    381 ;	-----------------------------------------
                                    382 ;	 function _mcs51_genXINIT
                                    383 ;	-----------------------------------------
      000037                        384 __mcs51_genXINIT:
      000037 22               [24]  385 	ret
                                    386 ;------------------------------------------------------------
                                    387 ;Allocation info for local variables in function '_mcs51_genXRAMCLEAR'
                                    388 ;------------------------------------------------------------
                                    389 ;	semaphoreDefine.c:64: void _mcs51_genXRAMCLEAR(void) { }
                                    390 ;	-----------------------------------------
                                    391 ;	 function _mcs51_genXRAMCLEAR
                                    392 ;	-----------------------------------------
      000038                        393 __mcs51_genXRAMCLEAR:
      000038 22               [24]  394 	ret
                                    395 	.area CSEG    (CODE)
                                    396 	.area CONST   (CODE)
                                    397 	.area XINIT   (CODE)
